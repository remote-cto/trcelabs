...
const LandingPage = forwardRef<HTMLDivElement>((props, ref) => {
  ...
  return (
    <div ref={ref} className="bg-gradient-to-br from-gray-900 to-gray-800 overflow-hidden">
          ...
          >
            <div className="mb-4">
              <p className="flex items-center justify-center space-x-2">
                ...
                <span className="font-bold text-green-400">Protect.</span>
                <span className="font-bold text-green-400">Detect.</span>
                <span className="font-bold text-green-400">Respond.</span>
            ...
            <p className="mb-4">
              ...
              stands as your trusted partner in cyber defense, digital forensics, and security education. We help businesses safeguard their critical assets through cutting-edge SIEM solutions, VAPT audits, digital forensics, and cybersecurity training.
            </p>
            <p>
              Our mission is to utilize technology to solve crimes, protect your digital footprint, and empower your business for the future.
            </p>
          </motion.div>
        </div>
      </section>
